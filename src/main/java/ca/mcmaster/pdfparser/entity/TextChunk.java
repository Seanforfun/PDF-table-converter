...
public class TextChunk extends RectangularTextContainer<TextElement> implements HasText {
     ...
     *
     * @param isLtrDominant true if LTR directionality is dominant
     * @return a TextChunk
     **/
    public TextChunk groupByDirectionality(Boolean isLtrDominant) {
        ...
        TextChunk chunk = new TextChunk(everything);
        chunk.setOverlapped(overlapped);
        return chunk;
    }
